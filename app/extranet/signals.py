...
def invalidate_leave_cache_on_save(sender, instance, **kwargs):
    ...
    try:
        ...
        logger.info(f"Cache invalidé pour {instance.user.username} suite à modification congé {instance.id}")
...
def invalidate_leave_cache_on_delete(sender, instance, **kwargs):
    ...
    try:
        ...
        logger.info(f"Cache invalidé pour {instance.user.username} suite à suppression congé {instance.id}")
...
def invalidate_telework_cache_on_save(sender, instance, **kwargs):
    ...
    try:
        ...
        logger.info(f"Cache rapport mensuel invalidé pour {instance.user.username} suite à modification télétravail {instance.id}")
...
def invalidate_telework_cache_on_delete(sender, instance, **kwargs):
    ...
    try:
        ...
        logger.info(f"Cache rapport mensuel invalidé pour {instance.user.username} suite à suppression télétravail {instance.id}")
