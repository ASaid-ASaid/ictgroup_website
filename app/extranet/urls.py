...
urlpatterns = [
    ...
    path(
        "demandes/validation/<int:leave_id>/",
        views.validate_leave,
        name="validate_leave",
    ),
    ...
    path(
        "teletravail/validation/<int:telework_id>/",
        views.validate_telework,
        name="validate_telework",
    ),
    path(
    ...
    path(
        "presence_calendar/", views.calendar_view, name="presence_calendar"
