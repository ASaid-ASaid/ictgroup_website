...
from extranet.models import UserProfile, LeaveRequest, TeleworkRequest, StockItem, StockMovement
...
class TeleworkRequestModelTest(TestCase):
    ...
    def test_telework_request_str_method(self):
        ...
        expected_str = f"Télétravail de {self.user.username} du {start_date} au {end_date}"
